...
test('test InsurancePlan', () => {
    const aidBoxDir = './data/aidbox/InsurancePlan';
    const fhirEntities = getEntitiesFromDir('./data/fhir/InsurancePlan');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/InsurancePlan';
