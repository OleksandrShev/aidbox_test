...
test('test RelatedPerson', () => {
    const aidBoxDir = './data/aidbox/RelatedPerson';
    const fhirEntities = getEntitiesFromDir('./data/fhir/RelatedPerson');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/RelatedPerson';
