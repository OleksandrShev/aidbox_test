...
test('test RequestGroup', () => {
    const aidBoxDir = './data/aidbox/RequestGroup';
    const fhirEntities = getEntitiesFromDir('./data/fhir/RequestGroup');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/RequestGroup';
