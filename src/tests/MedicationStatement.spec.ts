...
test('test MedicationStatement', () => {
    const aidBoxDir = './data/aidbox/MedicationStatement';
    const fhirEntities = getEntitiesFromDir('./data/fhir/MedicationStatement');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/MedicationStatement';
