...
test('test Practitioner', () => {
    const aidBoxDir = './data/aidbox/PractitionerRole';
    const fhirEntities = getEntitiesFromDir('./data/fhir/PractitionerRole');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/PractitionerRole';
