...
test('test CoverageEligibilityResponse', () => {
    const aidBoxDir = './data/aidbox/CoverageEligibilityResponse';
    const fhirEntities = getEntitiesFromDir('./data/fhir/CoverageEligibilityResponse');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/CoverageEligibilityResponse';
