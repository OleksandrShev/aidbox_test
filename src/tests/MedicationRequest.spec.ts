...
test('test MedicationRequest', () => {
    const aidBoxDir = './data/aidbox/MedicationRequest';
    const fhirEntities = getEntitiesFromDir('./data/fhir/MedicationRequest');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/MedicationRequest';
