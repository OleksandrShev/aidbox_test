...
test('test HealthcareService', () => {
    const aidBoxDir = './data/aidbox/HealthcareService';
    const fhirEntities = getEntitiesFromDir('./data/fhir/HealthcareService');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/HealthcareService';
