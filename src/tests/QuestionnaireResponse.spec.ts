...
test('test QuestionnaireResponse', () => {
    const aidBoxDir = './data/aidbox/QuestionnaireResponse';
    const fhirEntities = getEntitiesFromDir('./data/fhir/QuestionnaireResponse');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/QuestionnaireResponse';
