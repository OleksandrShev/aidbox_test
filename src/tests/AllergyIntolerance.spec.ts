...
test('test AllergyIntolerance', () => {
    const aidBoxDir = './data/aidbox/AllergyIntolerance';
    const fhirEntities = getEntitiesFromDir('./data/fhir/AllergyIntolerance');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/AllergyIntolerance';
