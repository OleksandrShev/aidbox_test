...
test('test DeviceRequest', () => {
    const aidBoxDir = './data/aidbox/DeviceRequest';
    const fhirEntities = getEntitiesFromDir('./data/fhir/DeviceRequest');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/DeviceRequest';
