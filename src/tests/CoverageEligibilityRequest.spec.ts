...
test('test CoverageEligibilityRequest', () => {
    const aidBoxDir = './data/aidbox/CoverageEligibilityRequest';
    const fhirEntities = getEntitiesFromDir('./data/fhir/CoverageEligibilityRequest');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/CoverageEligibilityRequest';
