...
test('test ChargeItem', () => {
    const aidBoxDir = './data/aidbox/ChargeItem';
    const fhirEntities = getEntitiesFromDir('./data/fhir/ChargeItem');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/ChargeItem';
