...
test('test DiagnosticReport', () => {
    const aidBoxDir = './data/aidbox/DiagnosticReport';
    const fhirEntities = getEntitiesFromDir('./data/fhir/DiagnosticReport');
    ...
    for (const aidBoxFile of aidBoxFiles) {
        ...
        const resultDir = './data/result/DiagnosticReport';
